...
def get_nombre_habitants_par_logement(url):
    ...
    section_wrapper = section_wrappers[20]
    ...
    target_rows = []
    target_labels = [
        "Résidences principales construites avant 1919",
        "Résidences principales construites de 1919 à 1945",
        "Résidences principales construites de 1946 à 1970",
        "Résidences principales construites de 1971 à 1990",
        "Résidences principales construites de 1991 à 2005",
        "Résidences principales construites après 2005"
    ]
...
df_final.to_csv("data_date_log.csv", index=False, encoding="utf-8-sig")

df = pd.read_csv("data_date_log.csv")
...
df.to_csv("data_data_log.csv", index=False, encoding="utf-8-sig")